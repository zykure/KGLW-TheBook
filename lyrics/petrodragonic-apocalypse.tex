...
\song{Motor Spirit}
\writtenby{Mackenzie/Walker/Cavanagh/Craig/Kenny-Smith/Harwood}
...
Thee kiss thy \word{God}, I kisseth ground. \\
...
By thee, we sleep and \word{die} for you. \\
...
Motorised \word{Apocalypse}. \\
See metal crunch and hear it. \\
Highway \word{death} by motor spirit. \\
...
Dance beneath the \word[moon]{Moon's} bright glow. \\
...
Bodies flying on a \word{rainbow}. \\
Run \word{Toto}. \\

Lightning bites the jaws of \word{Hell}. \\
...
Hill of \word{Gaash} flooding with flame. \\
Rips bark from dying trees. \\
\word{Tempest} breeds. \\
The \word{sky} bleeds, \word{dragon} feeds. \\
The messiah on their knees. \\
\word{Jupiter} laughs immortal. \\
Supercell. \\
...
Awaiting \word{death} while leaders hide. \\
Futures locked by land and wind. \\
Garden of \word{Eden} chagrined. \\

Drowning wind, gasp for breath. \\
Plain \word{snake}, omen of death. \\
...
From the \word{ISS}, ungodly high, \\
Chaos madness evolves below nigh. \\
A \word{tempest} of great force and might. \\
...
May the \word{Lord} have mercy on us all. \\
...
Storm dilates and people \word{die}. \\
...
Morphing twirling to single \word{beast}. \\
\word{Humanity}, tantalising feast. \\
...
Drink the blood, tasting \word{Tchort}. \\
What hath God wrought? \\

Converge, converge… \\

Hungry crawling, fat, grey \word{rat} \word{snake}. \\
...
For loss of \word{life}, destruction seen. \\
...
When the \word{Moon} does wane and \word{die}. \\
...
Hangs heavy with the \word[mother]{mother's} ire. \\
Witchcraft. \\

Antlers shed ribbons of blood. \\
Draped like thorns upon the brow. \\
A crucifixion can end this squall. \\
A \word{Bible} burned with aerosol. \\
Witchcraft. \\

I call upon the blood-\word{moon} \word{goddess} \\
...
Oh horrors, my midnight \word{God}, \\
...
I am \word{Beowulf}, I am cat, black. \\
...
\word{Moon} cycle shifting, demon lifting. \\
...
\song{Gila Monster}
\writtenby{Mackenzie/Walker/Cavanagh/Craig/Kenny-Smith}
...
With every \word{Wiccan} he will devour, \\
...
I'm the Gila, blood spiller, witch killer. (Gila! Gila!) \\
I'm the Gila, \word{Godzilla} guerilla. \\
...
Horny for bloodlust, \word{Lord} of pagan creatures. \\
Blacker than space, its eyes are distant \word[sun]{Suns}. \\
...
Compared to me, a \word{pulsar} is a lighter flame. \\
...
PetroDragonic \word{Apocalypse}… \\

Flapping wings, weaving through. \\
\word{Crocodile} obsolete. \\
...
{\itshape%
	...
	To the \word[heaven]{Heavens} above forever. \\
	I invoke this spell. \\
	The dragon appears. \\
...
A creature born of the \word{tempest}. \\
...
Depths of \word{Hell}, \word{dragon} rise. \\
\word{Death} in mind, smoking eyes. \\
Malice gleam, deadly guise. \\
Futile to hypothesise. \\
\word{Soul} blackened by the dark arts. \\
Strike a fear in mortal hearts. \\
Taketh to the \word{sky} with blazing darts. \\
...
The space station in a dragon \word{death roll}. \\
...
Through its teeth, cleansing \word{lava} flows. \\
...
\vocalsby{Leah Sensior}

The winds howled like ravenous wolves, clawing at the mansion's windows and doors. The \word{sky} had turned a murky shade of \word{death}, as if the clouds themselves were infected with the poison of a dying planet. The \word[human]{humans} inside the mansion toiled like frenzied ants, their hands trembling as they performed ancient rituals in feverish synchronicity. \\
...
The humans seemed oblivious to the spilled candle, their focus fully absorbed in ritual. Eyes fixed on the altar and hands moved with graceful purpose as they wove their spells. But as the fire's tendrils creeped across the room like a \word{snake} aroused from its slumber, it became clear that something was awry. The flames licked and hissed at the corners of the room, the fires hunger and intensity increasing with each passing moment. \\

I inhaled the smoke and felt an intense desire to be one with the fire. And so, I reached out and made contact. \\
A strange energy coursed through my body. Something trembled within me like a \word{Kraken} stirring in its watery grave. An ancient dormant force. My body began to grow and change, my scales shimmering and shifting as I took on a new form. \\
As the fire grew, so did I. My limbs elongated and new wings unfurled, my bones and muscles stretching and expanding to accommodate my new size. My head grew larger and \word{dragon}-like, my jaw widening and my teeth sharpening into deadly points. \\
The fire raged but I didn't burn. I was a phoenix rising from the ashes, a \word{butterfly} emerging from its chrysalis. My body was a canvas, painted with brushstrokes of smoke and flame. I was a shape-shifter, a changeling, a being of endless potential. My skin was a cloak, shedding its old self to reveal a new, shimmering version. My eyes were windows to a vast, untapped \word{universe}. My mind was a labyrinth, a puzzle waiting to be solved. \\
...
\note{[Paragraph on lyric sheet, but not in song.]}
...
The few remaining candles danced in the breeze that blew through the smashed windows. Outside encroached. The voices strained to compete with the deafening roar of the \word{tempest} and the cracking of timber as the mansion slowly crumbled into the inferno. \\
...
The few remaining humans can only hope to hide and wait for the storm to pass. But there is no escape from me and the storm will never pass. I am everywhere. I am the reckoning. I am the dragon. Coal-black cloud chokes the Earth. My flame is the only \word{Sun}. \\
